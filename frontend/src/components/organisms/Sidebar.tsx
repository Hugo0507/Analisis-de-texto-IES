      ...
      <aside className={`w-64 bg-slate-900 h-screen flex flex-col relative flex-shrink-0 overflow-y-auto scrollbar-hide ${className}`}>
        ...
        <div className="px-4 mb-2">
          <NavLink
            ...
            className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-cyan-500/30 bg-cyan-500/10 text-cyan-300 hover:bg-cyan-500/20 hover:border-cyan-400/50 transition-all duration-200 text-sm font-medium"
          >
